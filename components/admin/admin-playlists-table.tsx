...
interface AdminPlaylistsTableProps {
  playlists: Playlist[]
}

export function AdminPlaylistsTable({ playlists }: AdminPlaylistsTableProps) {
          ...
          >
            <div className="flex items-start justify-between gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                {playlist.shareSlug && (
                  <Link href={`/share/${playlist.shareSlug}`} target="_blank">
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              <br /><br />
              This playlist contains <strong>{playlistToDelete?._count.items} items</strong> and is publicly visible.
              <br /><br />
